...
assertCartPopupCtrl(strpos($ctrl, 'ProductPopupApplyIdentityService') !== false, 'reuse Phase 7 identity service');
...
fwrite(STDOUT, "OK (Phase 8 cartpopup/cartcalculator controller contract)\n");
