<div class="panel">
  ...
  <div class="panel-footer" style="display:flex;gap:8px;align-items:center;flex-wrap:wrap;">
    ...
    <button type="button" name="submitUnipaymentRefresh" class="btn btn-default" disabled="disabled" title="{l s='Ще бъде налично след връзката с Control Panel (Phase 2).' d='Modules.Unipayment.Admin'}"><i class="icon-refresh"></i> {l s='Обнови данните от банката' d='Modules.Unipayment.Admin'}</button>
  ...
  {if !$unipayment_cp_actions_available}
    <p class="help-block" style="margin-top:10px;">{l s='Действията „Обнови данните от банката“ и „Изтегли журнал операции“ са деактивирани до следващите имплементационни фази. Те не извършват връзка с Control Panel в Phase 1.' d='Modules.Unipayment.Admin'}</p>
  {/if}
</div>
